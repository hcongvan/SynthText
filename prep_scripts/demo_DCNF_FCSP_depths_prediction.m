...
img_dir='/data2/synth90k/dcnf-fcsp/custom_indoor_sample/'; 
img_type='indoor';
...
if strcmp(img_type, 'outdoor') 
    ...
    %outdoor scene model
    trained_model_file='../model_trained/Make3D_ResNet-UpProj'; 
end
...
if strcmp(img_type, 'indoor')
    ...
    %indoor scene model
    trained_model_file='../model_trained/NYU_ResNet-UpProj';   
end
